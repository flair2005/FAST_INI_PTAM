...
protected:
  ...
  //added by zyx 2017.8.13
  double mInitime;
  double mInitime2;
  bool isFirst;
  bool isFirst2;
//  void MonoRandomIniAlan2(CVD::Image<CVD::byte> src);
//  void DetectVanishingPoints(CVD::Image<CVD::byte> src, std::vector<CVD::Image<CVD::byte>> &vps);
//  void LineDetect( CVD::Image<CVD::byte> image, double thLength, std::vector<std::vector<cv::Point> > &lines );

  void MonoRandomIniAlan2(cv::Mat src);
  void TrackForInitialMap2(cv::Mat src);
